...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2020 a las 19:07:05
...
INSERT INTO `agricultura` (`ID`, `Nombre`, `Descripcion`, `Precio`, `ID_distribuidor`) VALUES
...
INSERT INTO `automoviles` (`ID`, `Nombre`, `Descripcion`, `Precio`, `ID_distribuidor`) VALUES
('1', 'Ale', 'qwqw', 256, '1');
...
INSERT INTO `construccion` (`ID`, `Producto`, `Descripcion`, `Precio`, `ID_distribuidor`) VALUES
...
('1', 'Luis Fernando', 'Gallardo Lopez', 28, 'saad'),
('2', 'jOSUE', 'GALLARO', 25, 'KJHDA');
